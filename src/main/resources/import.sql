...
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2021010101, "장우영", "2021-01-01", "음성 1센터", "equal", "F1-I", 1, "1111", "equal1234", 0, 1);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2023010101, "김민수", "2023-01-01", "음성 1센터", "minsukim", "F1-Ⅰ", 1, "1111", NULL, 7657, 0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2021030101, "허재민", "2021-03-01", "음성 1센터", "jaminheo", "F1-Ⅱ", 1, "1111", NULL, 17000, 0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2023010102, "성주현", "2023-01-01", "음성 1센터", "juhyeonsung", "F1-Ⅰ", 1, "1111", NULL, 6000,0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2018020101, "조선우", "2018-02-01", "음성 2센터", "seonwoocho", "F2-Ⅰ", 1, "1111", NULL, 37000,0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2022080101, "심유나", "2023-10-01", "음성 2센터", "yoonasim", "F1-Ⅰ", 1, "1111", NULL, 3000,0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2024090101, "양소영", "2022-09-01", "사업기획팀", "soyoungyang", "B1", 1, "1111", NULL, 17000,0);
INSERT INTO users (number, name, joinDate, career_name, id, level_level, part_name, password, newPassword, exp, userType) VALUES (2019090101, "김지수", "2019-09-01", "사업기획팀", "jisookim", "B2", 2, "1111", NULL, 40000,0);
...
-- 경험치 기록
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2023010101, '상반기 인사평가', '2023-06-30', 2023, 1500, 'C');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2021030101, '상반기 인사평가', '2023-06-30', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2023010102, '상반기 인사평가', '2023-06-30', 2023, 1500, 'C');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2018020101, '상반기 인사평가', '2023-06-30', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2022080101, '상반기 인사평가', '2023-06-30', 2023, 4500, 'A');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2024090101, '상반기 인사평가', '2023-06-30', 2023, 1500, 'C');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2019090101, '상반기 인사평가', '2023-06-30', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2023010101, '하반기 인사평가', '2023-12-31', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2021030101, '하반기 인사평가', '2023-12-31', 2023, 4500, 'A');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2023010102, '하반기 인사평가', '2023-12-31', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2018020101, '하반기 인사평가', '2023-12-31', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2022080101, '하반기 인사평가', '2023-12-31', 2023, 3000, 'B');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2024090101, '하반기 인사평가', '2023-12-31', 2023, 1500, 'C');
INSERT INTO `exp-history` (number, questType, updateDate, year, exp, grade) VALUES (2019090101, '하반기 인사평가', '2023-12-31', 2023, 1500, 'C');
...
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 1, '25-1-1', 2, 10, 4, 1, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 1, '25-1-2', 1, 20, 4, 1, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 1, '25-1-3', 4, 30, 5, 2, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 1, '25-1-4', 5, 10, 5, 2, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 1, '25-1-5', 6, 20, 5, 2, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 2, '25-1-6', 0, 30, 5, 2, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 2, '25-1-7', 1, 30, 5, 2, 1, 1, 1);
-- INSERT INTO `daily-productivity` (month, week, date, day, price, laborCosts, designFee, employeeSalaries, retirementBenefits, socialInsurance) VALUES (1, 2, '25-1-8', 2, 30, 5, 2, 1, 1, 1);
